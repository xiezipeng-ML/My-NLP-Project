    ...
    def make_dataset(self,file):
        ...
        with open(file, 'r',encoding='utf8') as f:
            ...
            for text,intent,slot in lines:
                text = self.config.tokz.convert_tokens_to_ids(list(text)[:self.config.max_len])  # 转换为单个idx
...
if __name__ == '__main__':
    ...
    data_loader = DataLoader(dataset,batch_size=30,collate_fn=PadBatchData(config))
